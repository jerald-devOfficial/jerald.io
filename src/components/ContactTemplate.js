...
function ContactTemplate() {
  return (
    <div className="flex flex-col justify-between">
      <div>
        <h2 className="text-4xl lg:text-5xl font-bold font-dosis leading-tight text-center">
          Wanna get to know more? Lets have a talk!
        </h2>
        <div className="text-gray-700 mt-8 flex justify-around">
          <a href="https://github.com/jerald-devOfficial">
            <GitHubIcon
              viewBox="0 0 27 24"
